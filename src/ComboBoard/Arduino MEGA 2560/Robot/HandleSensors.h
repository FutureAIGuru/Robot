...
public:
	...
	int pollingPeriod = 100;;          //'t' msecs -- how often to check the sensor value internally
	int reportingPeriod = 1000;        //'T' msecs -- how often to send the sensor value if no alert
	int minChange = -10000;            //'m' any value change less than this is considered no change
	int maxChange = 1000;              //'M' any value change more than this sends an alert message 
